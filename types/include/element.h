...
typedef rage_ProcessRequirements (*rage_ElementGetPortsDescription)(rage_Tuple params);
typedef void (*rage_ElementFreePortsDescription)(rage_ProcessRequirements);
typedef rage_Error (*rage_ElementProcess)(void * state, rage_Time time, rage_Ports const * ports);
